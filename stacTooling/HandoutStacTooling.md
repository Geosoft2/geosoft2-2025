...
* stac-utils (o.J.): *PySTAC.* [https://github.com/stac-utils/pystac](https://github.com/stac-utils/pystac) (zuletzt aufgerufen am 25.10.2025)
* stac-utils (o.J.): *pystac-client.* [https://github.com/stac-utils/pystac-client](https://github.com/stac-utils/pystac-client) (zuletzt aufgerufen am 25.10.2025)
* Azavea, Radiant Earth Foundation (o.J.): *PySTAC Documentation.* [https://pystac.readthedocs.io/en/stable/](https://pystac.readthedocs.io/en/stable/) (zuletzt aufgerufen am 25.10.2025)
* Duckworth, J. (o. J.): pystac-client — Documentation. https://pystac-client.readthedocs.io/en/stable/ (zuletzt aufgerufen am 25.10.2025)
* STAC Index (o. J.): STAC Index — Discover STAC catalogs, APIs & tools. https://stacindex.org/ (zuletzt aufgerufen am 25.10.2025)
* Mohr, M.; Deziel, Z. (o. J.): stac-index (GitHub Repository). https://github.com/moregeo-it/stac-index (zuletzt aufgerufen am 25.10.2025)
* Radiant Earth / STAC Community (o. J.): STAC — SpatioTemporal Asset Catalogs (offizielle Spezifikation). https://stacspec.org/en (zuletzt aufgerufen am 25.10.2025)
